...
charStr = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
# print re.search(r'[A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z]', charStr)
# print re.search(r'[A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z]', charStr).group(0)
# print re.search(r'[^A-Z][A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z][^A-Z]', charStr).group(0)
# print re.findall(r'[^A-Z][A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z][^A-Z]', charStr).group(0)
print re.findall(r'[^A-Z][A-Z][A-Z][A-Z][a-z][A-Z][A-Z][A-Z][^A-Z]', charStr)
